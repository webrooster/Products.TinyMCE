...
(function() {
	...
	tinymce.create('tinymce.AddOnManager', {
		...
		load : function(n, u, cb, s) {
			var t = this;
			var st = tinymce.EditorManager.settings;

			if (t.urls[n])
				return;

			if (u.indexOf('/') != 0 && u.indexOf('://') == -1)
				u = st.portal_url + '/++resource++tinymce.javascripts/' +  u;
...
(function() {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.iframeHTML = s.doctype + '<html id="region-content"><head xmlns="http://www.w3.org/1999/xhtml"><base href="' + t.documentBaseURI.getURI() + '" />';
